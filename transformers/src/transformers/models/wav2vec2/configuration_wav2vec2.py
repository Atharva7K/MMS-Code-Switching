...
class Wav2Vec2Config(PretrainedConfig):
    ...
    def __init__(
        ...
        adapter_attn_dim=16,
        do_code_switching = True,
        adapter_switching_type = 'post',
        code_switch_between = ['ara', 'en'],
        **kwargs,
    ):
        ...
        self.do_code_switching = do_code_switching
        self.code_switch_between = code_switch_between
        self.adapter_switching_type = adapter_switching_type
